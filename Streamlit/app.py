...
with scatter_col:
    ...
    # Group data to count duplicates
    bubble_df = (
    ...
    fig = px.scatter(
        ...
        x="Percentile",
        y="Firstscore",
        size="Count",  # This controls the bubble size
        color="Subject",
    ...
    height=450,
    margin={"t": 10},
    font=dict(family="Arial", color="#113f67"),  # General font color
...
with bar_col1:
    ...
    fig1.update_layout(
        ...
        xaxis=dict(title_font=dict(size=14, color="#113f67"), tickfont=dict(size=12, color="#113f67")),
        yaxis=dict(title_font=dict(size=14, color="#113f67"), tickfont=dict(size=12, color="#113f67"))
    )
